    ...
    var p = CryptoJS
      ...
      , v = d.Cipher = t.extend({
        ...
        createDecryptor: function(e, a) {
            return this.create(this.bvc2x, e, a)
        },
        init: function(e, a, b) {
...
(function() {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
      , d = d.AES = p.extend({
        mx6r: function() {
            for (var a = this.J3x, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.bil1x = d + 6) + 1), e = this.bva2x = [], j = 0; j < a; j++)
                if (j < d)
                    e[j] = c[j];
                else {
                    var k = e[j - 1];
        ...
        encryptBlock: function(a, b) {
            this.Fn1x(a, b, this.bva2x, t, r, w, v, l)
        },
        decryptBlock: function(a, c) {
            var d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d;
            this.Fn1x(a, c, this.buW2x, b, x, q, n, s);
            d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d
        },
        Fn1x: function(a, b, c, d, e, j, l, f) {
...
function firstEnc(d, e, f, g) {
    var h = {}
        , i = a(16);
    return h.encText = get_f(d, g),
        h.encText = get_f(h.encText, i),
        h.encSecKey = c(i, e, f),
        h
}
var i2x={
...
function main(){
    var bKB4F=firstEnc(JSON.stringify(i2x), "010001","", "0CoJUm6Qyw8W8jud");
    var data={
