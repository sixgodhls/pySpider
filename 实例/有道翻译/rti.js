...
rpar = "" + (new Date).getTime();
ipar = rpar + parseInt(10 * Math.random(), 10);
// var r, i, o, a, s = function(key) {
//   return new s.fn.init('猫',"bb83060ffd82319d0181543ee2d7f893",ipar)
// }
...
function get_dict(parmars){
  return {
    'lts':rpar,
    'salt':ipar,
    'bv':"bb83060ffd82319d0181543ee2d7f893",
    'sign':md5("fanyideskweb" + parmars + ipar + "Ygy_4c=r#e#4EX^NUGUc5")
  }
}
