...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
        ...
        if (needsExpansion) {
            for (int i8 = 0; i8 < childCount; i8++) {
                ...
                if (lp5.expanded) {
                    ...
                    child4.measure(View.MeasureSpec.makeMeasureSpec(width, MemoryConstants.f216GB), itemHeightSpec);
                }
            }
        }
    ...
    public static int measureChildForCells(View child, int cellSize, int cellsRemaining, int parentHeightMeasureSpec, int parentHeightPadding) {
        ...
        child.measure(View.MeasureSpec.makeMeasureSpec(targetWidth, MemoryConstants.f216GB), childHeightSpec);
        return cellsUsed;
    }
    ...
    public LayoutParams mo223generateDefaultLayoutParams() {
    ...
    public LayoutParams mo224generateLayoutParams(AttributeSet attrs) {
    ...
    @Override // android.support.p003v7.widget.LinearLayoutCompat, android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo225generateLayoutParams(ViewGroup.LayoutParams p) {
        if (p != null) {
        ...
        return mo223generateDefaultLayoutParams();
    }
    ...
    public LayoutParams generateOverflowButtonLayoutParams() {
        LayoutParams result = mo223generateDefaultLayoutParams();
