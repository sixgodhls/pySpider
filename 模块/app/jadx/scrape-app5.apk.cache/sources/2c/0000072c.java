...
public class Toolbar extends ViewGroup {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            LayoutParams lp = mo240generateDefaultLayoutParams();
    ...
    private void addSystemView(View v, boolean allowHide) {
        ...
        if (vlp == null) {
            lp = mo240generateDefaultLayoutParams();
        } else if (!checkLayoutParams(vlp)) {
            lp = mo242generateLayoutParams(vlp);
        } else {
            lp = (LayoutParams) vlp;
        }
        lp.mViewType = 1;
    ...
    private void measureChildConstrained(View child, int parentWidthSpec, int widthUsed, int parentHeightSpec, int heightUsed, int heightConstraint) {
        ...
        if (childHeightMode != 1073741824 && heightConstraint >= 0) {
            ...
            childHeightSpec = View.MeasureSpec.makeMeasureSpec(size, MemoryConstants.f216GB);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (shouldLayout(this.mMenuView)) {
            ...
            childState = View.combineMeasuredStates(childState4, this.mMenuView.getMeasuredState());
            childState2 = height3;
            height = menuWidth3;
        } else {
            marginStartIndex2 = 0;
        ...
        if (shouldLayout(this.mExpandedActionView)) {
            ...
            childState3 = View.combineMeasuredStates(childState, this.mExpandedActionView.getMeasuredState());
        } else {
        ...
        int measuredWidth = View.resolveSizeAndState(Math.max(width5, getSuggestedMinimumWidth()), widthMeasureSpec, (-16777216) & childState3);
        int measuredHeight = View.resolveSizeAndState(Math.max(height7, getSuggestedMinimumHeight()), heightMeasureSpec, childState3 << 16);
    ...
    */
    ...
    public LayoutParams mo241generateLayoutParams(AttributeSet attrs) {
    ...
    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo242generateLayoutParams(ViewGroup.LayoutParams p) {
    ...
    public LayoutParams mo240generateDefaultLayoutParams() {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.v7.widget.Toolbar.SavedState.1
            ...
            public SavedState mo244createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo243createFromParcel(Parcel in) {
                return new SavedState(in, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo245newArray(int size) {
    ...
    public class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (expandedActionParent != toolbar3) {
                ...
                LayoutParams lp = Toolbar.this.mo240generateDefaultLayoutParams();
