...
class TransitionUtils {
    ...
    public static View copyViewImage(ViewGroup sceneRoot, View view, View parent) {
        ...
        int widthSpec = View.MeasureSpec.makeMeasureSpec(right - left, MemoryConstants.f216GB);
        int heightSpec = View.MeasureSpec.makeMeasureSpec(bottom - top, MemoryConstants.f216GB);
