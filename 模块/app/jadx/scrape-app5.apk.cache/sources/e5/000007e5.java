...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            this.tabTextSize = ta.getDimensionPixelSize(C0452R.styleable.TextAppearance_android_textSize, 0);
            ...
            if (a.hasValue(C0091R.styleable.TabLayout_tabSelectedTextColor)) {
                int selected = a.getColor(C0091R.styleable.TabLayout_tabSelectedTextColor, 0);
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), selected);
            }
            int selected2 = C0091R.styleable.TabLayout_tabIconTint;
            ...
            this.tabTextMultiLineSize = res.getDimensionPixelSize(C0091R.dimen.design_tab_text_size_2line);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (getChildCount() == 1) {
            ...
            if (remeasure) {
                ...
                int childWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), MemoryConstants.f216GB);
