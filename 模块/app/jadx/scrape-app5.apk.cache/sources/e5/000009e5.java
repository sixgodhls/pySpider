...
public final class FlowableCombineLatest<T, R> extends Flowable<R> {
    ...
    static final class CombineLatestCoordinator<T, R> extends BasicIntQueueSubscription<R> {
        ...
        void drainAsync() {
            ...
            do {
                ...
                while (e != r) {
                    ...
                    try {
                        a.onNext((Object) ObjectHelper.requireNonNull(this.combiner.mo401apply((Object[]) q.mo399poll()), "The combiner returned a null value"));
        ...
        @Nullable
        /* renamed from: poll */
        public R mo399poll() throws Exception {
            Object e = this.queue.mo399poll();
            if (e == null) {
                return null;
            }
            R r = (R) ObjectHelper.requireNonNull(this.combiner.mo401apply((Object[]) this.queue.mo399poll()), "The combiner returned a null value");
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        /* renamed from: apply */
        public R mo401apply(T t) throws Exception {
            return FlowableCombineLatest.this.combiner.mo401apply(new Object[]{t});
        }
    }
}