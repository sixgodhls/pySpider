...
public abstract class Transition implements Cloneable {
    ...
    public Transition mo141setDuration(long duration) {
    ...
    public Transition mo144setStartDelay(long startDelay) {
    ...
    public Transition mo142setInterpolator(@Nullable TimeInterpolator interpolator) {
    ...
    public Transition mo132addTarget(@NonNull View target) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo131addTarget(@IdRes int targetId) {
        if (targetId != 0) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo134addTarget(@NonNull String targetName) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo133addTarget(@NonNull Class targetType) {
        if (this.mTargetTypes == null) {
    ...
    public Transition mo138removeTarget(@NonNull View target) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo137removeTarget(@IdRes int targetId) {
        if (targetId != 0) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo140removeTarget(@NonNull String targetName) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo139removeTarget(@NonNull Class target) {
    ...
    public Transition mo130addListener(@NonNull TransitionListener listener) {
    ...
    public Transition mo136removeListener(@NonNull TransitionListener listener) {
        ArrayList<TransitionListener> arrayList = this.mListeners;
        if (arrayList == null) {
            return this;
        }
    ...
    public Transition mo143setSceneRoot(ViewGroup sceneRoot) {
