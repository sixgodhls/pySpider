...
public final class CollapsingTextHelper {
    ...
    public void setCollapsedTextAppearance(int resId) {
        ...
        if (a.hasValue(C0452R.styleable.TextAppearance_android_textSize)) {
            this.collapsedTextSize = a.getDimensionPixelSize(C0452R.styleable.TextAppearance_android_textSize, (int) this.collapsedTextSize);
        }
    ...
    public void setExpandedTextAppearance(int resId) {
        ...
        if (a.hasValue(C0452R.styleable.TextAppearance_android_textSize)) {
            this.expandedTextSize = a.getDimensionPixelSize(C0452R.styleable.TextAppearance_android_textSize, (int) this.expandedTextSize);
        }
    ...
    public void setExpansionFraction(float fraction) {
        float fraction2 = android.support.p000v4.math.MathUtils.clamp(fraction, 0.0f, 1.0f);
