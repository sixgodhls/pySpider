    ...
    */
    public void enqueueAction(android.support.p000v4.app.FragmentManagerImpl.OpGenerator r3, boolean r4) {
        ...
        L5:
            ...
            if (r0 != 0) goto L24
            android.support.v4.app.FragmentHostCallback r0 = r2.mHost     // Catch: java.lang.Throwable -> L30
            if (r0 != 0) goto Lf
            goto L24
        Lf:
            java.util.ArrayList<android.support.v4.app.FragmentManagerImpl$OpGenerator> r0 = r2.mPendingActions     // Catch: java.lang.Throwable -> L30
            if (r0 != 0) goto L1a
        ...
        public void onAnimationEnd(Animation animation) {
            if (ViewCompat.isAttachedToWindow(this.mView) || Build.VERSION.SDK_INT >= 24) {
                this.mView.post(new Runnable() { // from class: android.support.v4.app.FragmentManagerImpl.AnimateOnHWLayerIfNeededListener.1
                    {
                        AnimateOnHWLayerIfNeededListener.this = this;
                    }
