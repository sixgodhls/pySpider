...
public class SwitchCompat extends CompoundButton {
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        ...
        int typefaceIndex = appearance.getInt(C0452R.styleable.TextAppearance_android_typeface, -1);
        int styleIndex = appearance.getInt(C0452R.styleable.TextAppearance_android_textStyle, -1);
        setSwitchTypefaceByIndex(typefaceIndex, styleIndex);
        boolean allCaps = appearance.getBoolean(C0452R.styleable.TextAppearance_textAllCaps, false);
        if (allCaps) {
    ...
    private Layout makeLayout(CharSequence text) {
        ...
        TextPaint textPaint = this.mTextPaint;
        return new StaticLayout(transformed, textPaint, transformed != null ? (int) Math.ceil(Layout.getDesiredWidth(transformed, textPaint)) : 0, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
    }
