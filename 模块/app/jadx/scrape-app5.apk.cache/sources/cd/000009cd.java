    ...
    static final class DistinctSubscriber<T, K> extends BasicFuseableSubscriber<T, T> {
        ...
        public void onNext(T value) {
            ...
            if (this.sourceMode == 0) {
                try {
                    boolean b = this.collection.add(ObjectHelper.requireNonNull(this.keySelector.mo401apply(value), "The keySelector returned a null key"));
                    if (b) {
        ...
        public T mo399poll() throws Exception {
            ...
            while (true) {
                v = this.f180qs.poll();
                if (v == null || this.collection.add((Object) ObjectHelper.requireNonNull(this.keySelector.mo401apply(v), "The keySelector returned a null key"))) {
                    break;
