...
public final class ObservableMapNotification<T, R> extends AbstractObservableWithUpstream<T, ObservableSource<? extends R>> {
    ...
    static final class MapNotificationObserver<T, R> implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            try {
                ObservableSource<? extends R> p = (ObservableSource) ObjectHelper.requireNonNull(this.onNextMapper.mo401apply(t), "The onNext ObservableSource returned is null");
        ...
        public void onError(Throwable t) {
            try {
                ObservableSource<? extends R> p = (ObservableSource) ObjectHelper.requireNonNull(this.onErrorMapper.mo401apply(t), "The onError ObservableSource returned is null");
                this.downstream.onNext(p);
