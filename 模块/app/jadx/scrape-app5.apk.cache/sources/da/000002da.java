...
public class ControlDistributeLinearLayout extends LinearLayout {
    ...
    public ControlDistributeLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, C0933R.styleable.ControlDistributeLinearLayout);
        this.isDistributeEvent = typedArray.getBoolean(C0933R.styleable.ControlDistributeLinearLayout_distribute_event, false);
    }
