...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        ...
        TypedArray array = resources.obtainAttributes(attrs, C0070R.styleable.FontFamily);
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        AttributeSet attrs = Xml.asAttributeSet(parser);
        TypedArray array = resources.obtainAttributes(attrs, C0070R.styleable.FontFamilyFont);
        int weightAttr = array.hasValue(C0070R.styleable.FontFamilyFont_fontWeight) ? C0070R.styleable.FontFamilyFont_fontWeight : C0070R.styleable.FontFamilyFont_android_fontWeight;
        int weight = array.getInt(weightAttr, NORMAL_WEIGHT);
        int styleAttr = array.hasValue(C0070R.styleable.FontFamilyFont_fontStyle) ? C0070R.styleable.FontFamilyFont_fontStyle : C0070R.styleable.FontFamilyFont_android_fontStyle;
        ...
        int variationSettingsAttr = array.hasValue(C0070R.styleable.FontFamilyFont_fontVariationSettings) ? C0070R.styleable.FontFamilyFont_fontVariationSettings : C0070R.styleable.FontFamilyFont_android_fontVariationSettings;
