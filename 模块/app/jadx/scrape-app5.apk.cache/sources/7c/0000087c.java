...
public final class SingleDelay<T> extends Single<T> {
    ...
    final class Delay implements SingleObserver<T> {
        ...
        public void onError(Throwable e) {
            this.f171sd.replace(SingleDelay.this.scheduler.scheduleDirect(new OnError(e), SingleDelay.this.delayError ? SingleDelay.this.time : 0L, SingleDelay.this.unit));
        }
