...
public class ActionBarContextView extends AbsActionBarView {
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            inflater.inflate(C0452R.layout.abc_action_bar_title_item, this);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        View closeButton = this.mClose.findViewById(C0452R.C0455id.action_mode_close_button);
        closeButton.setOnClickListener(new View.OnClickListener() { // from class: android.support.v7.widget.ActionBarContextView.1
