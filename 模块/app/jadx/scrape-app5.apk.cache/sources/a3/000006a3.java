...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            int descendantFocusability = a2.getInt(C0460R.styleable.RecyclerView_android_descendantFocusability, -1);
            if (descendantFocusability == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a2.getBoolean(C0460R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                StateListDrawable verticalThumbDrawable = (StateListDrawable) a2.getDrawable(C0460R.styleable.RecyclerView_fastScrollVerticalThumbDrawable);
                Drawable verticalTrackDrawable = a2.getDrawable(C0460R.styleable.RecyclerView_fastScrollVerticalTrackDrawable);
                StateListDrawable horizontalThumbDrawable = (StateListDrawable) a2.getDrawable(C0460R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable);
                Drawable horizontalTrackDrawable = a2.getDrawable(C0460R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable);
    ...
    */
    ...
    public class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                boolean fullyConsumedVertical = dy != 0 && RecyclerView.this.mLayout.canScrollVertically() && adapterSize == dy;
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public abstract VH mo257onCreateViewHolder(@NonNull ViewGroup viewGroup, int i);
        ...
        public final VH createViewHolder(@NonNull ViewGroup parent, int viewType) {
            try {
                ...
                VH holder = mo257onCreateViewHolder(parent, viewType);
                if (holder.itemView.getParent() != null) {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.v7.widget.RecyclerView.SavedState.1
            ...
            public SavedState mo231createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo230createFromParcel(Parcel in) {
                return new SavedState(in, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo232newArray(int size) {
