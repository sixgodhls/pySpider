...
final class Http2Writer implements Closeable {
    ...
    public synchronized void connectionPreface() throws IOException {
        ...
        this.sink.mo414write(Http2.CONNECTION_PREFACE.toByteArray());
        this.sink.flush();
    }
    ...
    public synchronized void pushPromise(int streamId, int promisedStreamId, List<Header> requestHeaders) throws IOException {
        ...
        this.sink.mo419writeInt(Integer.MAX_VALUE & promisedStreamId);
    ...
    public synchronized void rstStream(int streamId, ErrorCode errorCode) throws IOException {
        ...
        this.sink.mo419writeInt(errorCode.httpCode);
        this.sink.flush();
    }
    ...
    public synchronized void settings(Settings settings) throws IOException {
        ...
        for (int i = 0; i < 10; i++) {
            if (settings.isSet(i)) {
                ...
                this.sink.mo423writeShort(id);
                this.sink.mo419writeInt(settings.get(i));
            }
        }
        this.sink.flush();
    }
    ...
    public synchronized void ping(boolean ack, int payload1, int payload2) throws IOException {
        ...
        this.sink.mo419writeInt(payload1);
        this.sink.mo419writeInt(payload2);
        this.sink.flush();
    }
    ...
    public synchronized void goAway(int lastGoodStreamId, ErrorCode errorCode, byte[] debugData) throws IOException {
        ...
        this.sink.mo419writeInt(lastGoodStreamId);
        this.sink.mo419writeInt(errorCode.httpCode);
        if (debugData.length > 0) {
            this.sink.mo414write(debugData);
        }
        this.sink.flush();
    }
    ...
    public synchronized void windowUpdate(int streamId, long windowSizeIncrement) throws IOException {
        ...
        this.sink.mo419writeInt((int) windowSizeIncrement);
        this.sink.flush();
    }
    ...
    public void frameHeader(int streamId, int length, byte type, byte flags) throws IOException {
        ...
        if (length <= i) {
            ...
            this.sink.mo416writeByte(type & 255);
            this.sink.mo416writeByte(flags & 255);
            this.sink.mo419writeInt(Integer.MAX_VALUE & streamId);
            return;
        }
    ...
    private static void writeMedium(BufferedSink sink, int i) throws IOException {
        sink.mo416writeByte((i >>> 16) & 255);
        sink.mo416writeByte((i >>> 8) & 255);
        sink.mo416writeByte(i & 255);
    }
