...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        @Override // com.google.gson.TypeAdapter
        /* renamed from: read */
        public Map<K, V> mo353read(JsonReader in) throws IOException {
            ...
            if (peek == JsonToken.BEGIN_ARRAY) {
                ...
                while (in.hasNext()) {
                    in.beginArray();
                    K key = this.keyTypeAdapter.mo353read(in);
                    V value = this.valueTypeAdapter.mo353read(in);
                ...
                while (in.hasNext()) {
                    ...
                    K key2 = this.keyTypeAdapter.mo353read(in);
                    V value2 = this.valueTypeAdapter.mo353read(in);
