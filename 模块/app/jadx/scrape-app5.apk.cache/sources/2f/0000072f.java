...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public void setMeasuredDimension(Rect childrenBounds, int wSpec, int hSpec) {
        ...
        if (this.mOrientation == 1) {
            ...
            int usedWidth2 = chooseSize(hSpec, (this.mSizePerSpan * this.mSpanCount) + verticalPadding, getMinimumHeight());
            width = usedWidth2;
            usedHeight = width3;
        }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (getChildCount() > 0) {
            ...
            state.mSpanOffsetsSize = i;
            state.mSpanOffsets = new int[i];
            for (int i2 = 0; i2 < this.mSpanCount; i2++) {
                if (this.mLastLayoutFromEnd) {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (true) {
            if (layoutState.hasMore(state)) {
                ...
                if (layoutState.mLayoutDirection == r10) {
                    if (lp.mFullSpan) {
                        start2 = getMaxEnd(defaultNewViewLine);
                    } else {
                        start2 = currentSpan.getEndLine(defaultNewViewLine);
                    }
                    int end3 = this.mPrimaryOrientation.getDecoratedMeasurement(view) + start2;
                    ...
                    int start3 = end - this.mPrimaryOrientation.getDecoratedMeasurement(view);
                    if (assignSpan && lp.mFullSpan) {
                        LazySpanLookup.FullSpanItem fullSpanItem2 = createFullSpanItemFromStart(end);
                        int i4 = r10 == true ? 1 : 0;
                        int i5 = r10 == true ? 1 : 0;
                        fullSpanItem2.mGapDir = i4;
                ...
                if (lp.mFullSpan && layoutState.mItemDirection == -1) {
                    if (assignSpan) {
                        ...
                        if (layoutState.mLayoutDirection == r10) {
                            ...
                            hasInvalidGap = (areAllStartsEqual ? 1 : 0) ^ z2;
                        }
                        if (hasInvalidGap) {
                ...
                if (isLayoutRTL() && this.mOrientation == r10) {
                    ...
                    otherEnd = otherEnd2;
                    otherStart2 = otherEnd2 - this.mSecondaryOrientation.getDecoratedMeasurement(view);
                } else {
                    if (lp.mFullSpan) {
                    ...
                    otherStart2 = otherStart;
                    otherEnd = this.mSecondaryOrientation.getDecoratedMeasurement(view) + otherStart;
                }
                int otherStart3 = this.mOrientation;
                if (otherStart3 == r10) {
                    currentSpan2 = currentSpan;
                    layoutDecoratedWithMargins(view, otherStart2, start, otherEnd, end2);
                } else {
                    currentSpan2 = currentSpan;
                    layoutDecoratedWithMargins(view, start, otherStart2, end2, otherEnd);
                }
                if (lp.mFullSpan) {
        ...
        return diff > 0 ? Math.min(layoutState.mAvailable, diff) : i;
    }
    ...
    public static class LazySpanLookup {
        ...
        public static class FullSpanItem implements Parcelable {
            public static final Parcelable.Creator<FullSpanItem> CREATOR = new Parcelable.Creator<FullSpanItem>() { // from class: android.support.v7.widget.StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem.1
                ...
                public FullSpanItem mo236createFromParcel(Parcel in) {
                ...
                public FullSpanItem[] mo237newArray(int size) {
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: android.support.v7.widget.StaggeredGridLayoutManager.SavedState.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo238createFromParcel(Parcel in) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo239newArray(int size) {
