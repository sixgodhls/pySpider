...
public final class Http1Codec implements HttpCodec {
    ...
    public void writeRequest(Headers headers, String requestLine) throws IOException {
        ...
        this.sink.mo427writeUtf8(requestLine).mo427writeUtf8("\r\n");
        int size = headers.size();
        for (int i = 0; i < size; i++) {
            this.sink.mo427writeUtf8(headers.name(i)).mo427writeUtf8(": ").mo427writeUtf8(headers.value(i)).mo427writeUtf8("\r\n");
        }
        this.sink.mo427writeUtf8("\r\n");
        this.state = 1;
    }
    ...
    public final class ChunkedSink implements Sink {
        ...
        public void write(Buffer source, long byteCount) throws IOException {
            ...
            Http1Codec.this.sink.mo418writeHexadecimalUnsignedLong(byteCount);
            Http1Codec.this.sink.mo427writeUtf8("\r\n");
            Http1Codec.this.sink.write(source, byteCount);
            Http1Codec.this.sink.mo427writeUtf8("\r\n");
        }
        ...
        public synchronized void close() throws IOException {
            ...
            this.closed = true;
            Http1Codec.this.sink.mo427writeUtf8("0\r\n\r\n");
            Http1Codec.this.detachTimeout(this.timeout);
            Http1Codec.this.state = 3;
        }
    }
