...
public interface SupportMenuItem extends MenuItem {
    ...
    MenuItem mo213setActionView(int i);

    @Override // android.view.MenuItem
    /* renamed from: setActionView */
    MenuItem mo214setActionView(View view);
    ...
    SupportMenuItem mo215setContentDescription(CharSequence charSequence);
    ...
    MenuItem mo216setShowAsActionFlags(int i);

    SupportMenuItem setSupportActionProvider(ActionProvider actionProvider);

    @Override // android.view.MenuItem
    /* renamed from: setTooltipText */
    SupportMenuItem mo217setTooltipText(CharSequence charSequence);
}