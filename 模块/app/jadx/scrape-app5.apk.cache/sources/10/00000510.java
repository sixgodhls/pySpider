...
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem {
    ...
    public MenuItem setShowAsActionFlags(int actionEnum) {
        ((SupportMenuItem) this.mWrappedObject).mo216setShowAsActionFlags(actionEnum);
        return this;
    }
    ...
    public MenuItem setActionView(View view) {
        ...
        ((SupportMenuItem) this.mWrappedObject).mo214setActionView(view);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setActionView(int resId) {
        ((SupportMenuItem) this.mWrappedObject).mo213setActionView(resId);
        View actionView = ((SupportMenuItem) this.mWrappedObject).getActionView();
        if (actionView instanceof CollapsibleActionView) {
            ((SupportMenuItem) this.mWrappedObject).mo214setActionView(new CollapsibleActionViewWrapper(actionView));
        }
        return this;
    }
    ...
    public MenuItem setContentDescription(CharSequence contentDescription) {
        ((SupportMenuItem) this.mWrappedObject).mo215setContentDescription(contentDescription);
        return this;
    }
    ...
    public MenuItem setTooltipText(CharSequence tooltipText) {
        ((SupportMenuItem) this.mWrappedObject).mo217setTooltipText(tooltipText);
        return this;
    }
