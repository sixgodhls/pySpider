...
public class DialogInit {
    ...
    public static void init(MaterialDialog dialog) {
        ...
        if (!builder.titleColorSet) {
            ...
            builder.titleColor = DialogUtils.resolveColor(builder.context, C0582R.attr.md_title_color, titleColorFallback);
        }
        if (!builder.contentColorSet) {
            int contentColorFallback = DialogUtils.resolveColor(dialog.getContext(), 16842808);
            builder.contentColor = DialogUtils.resolveColor(builder.context, C0582R.attr.md_content_color, contentColorFallback);
        }
        ...
        if (!builder.dividerColorSet) {
            int dividerFallback = DialogUtils.resolveColor(dialog.getContext(), C0582R.attr.md_divider);
            builder.dividerColor = DialogUtils.resolveColor(builder.context, C0582R.attr.md_divider_color, dividerFallback);
        }
        ...
        int maxWidth = builder.context.getResources().getDimensionPixelSize(C0582R.dimen.md_dialog_max_width);
