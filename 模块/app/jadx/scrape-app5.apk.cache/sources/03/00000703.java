...
public abstract class BaseTestConsumer<T, U extends BaseTestConsumer<T, U>> implements Disposable {
    ...
    public abstract U mo408assertNotSubscribed();

    /* renamed from: assertSubscribed */
    public abstract U mo409assertSubscribed();
    ...
    public final U assertValuesOnly(T... values) {
        return (U) mo409assertSubscribed().assertValues(values).assertNoErrors().assertNotComplete();
    }
    ...
    public final U assertValueSetOnly(Collection<? extends T> expected) {
        return (U) mo409assertSubscribed().assertValueSet(expected).assertNoErrors().assertNotComplete();
    }
    ...
    public final U assertValueSequenceOnly(Iterable<? extends T> sequence) {
        return (U) mo409assertSubscribed().assertValueSequence(sequence).assertNoErrors().assertNotComplete();
    }
    ...
    public final U assertResult(T... values) {
        return (U) mo409assertSubscribed().assertValues(values).assertNoErrors().assertComplete();
    }

    public final U assertFailure(Class<? extends Throwable> error, T... values) {
        return (U) mo409assertSubscribed().assertValues(values).assertError(error).assertNotComplete();
    }

    public final U assertFailure(Predicate<Throwable> errorPredicate, T... values) {
        return (U) mo409assertSubscribed().assertValues(values).assertError(errorPredicate).assertNotComplete();
    }

    public final U assertFailureAndMessage(Class<? extends Throwable> error, String message, T... values) {
        return (U) mo409assertSubscribed().assertValues(values).assertError(error).assertErrorMessage(message).assertNotComplete();
    }
    ...
    public final U assertEmpty() {
        return (U) mo409assertSubscribed().assertNoValues().assertNoErrors().assertNotComplete();
    }
