    ...
    void applyTransformation(float interpolatedTime, Ring ring, boolean lastFrame) {
        ...
        if (this.mFinishing) {
            ...
            if (interpolatedTime < SHRINK_OFFSET) {
                ...
                float endTrim = (MATERIAL_INTERPOLATOR.getInterpolation(scaledTime2) * 0.79f) + MIN_PROGRESS_ARC + startTrim2;
                scaledTime = startTrim2;
                startTrim = endTrim;
            } else {
                float endTrim2 = interpolatedTime - SHRINK_OFFSET;
                float scaledTime3 = endTrim2 / SHRINK_OFFSET;
