...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (Math.abs(this.f11mX[0]) > 1.0E-5d || Math.abs(this.f12mY[0]) > 1.0E-5d || Math.abs(this.f11mX[numPoints - 1] - 1.0f) > 1.0E-5d || Math.abs(this.f12mY[numPoints - 1] - 1.0f) > 1.0E-5d) {
