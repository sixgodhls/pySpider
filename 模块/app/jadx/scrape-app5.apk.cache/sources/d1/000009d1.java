    ...
    static final class JoinDisposable<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger implements Disposable, ObservableGroupJoin.JoinSupport {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                Integer mode = (Integer) q.mo399poll();
                ...
                if (d && empty) {
                    ...
                    Object val = q.mo399poll();
                    if (mode == LEFT_VALUE) {
                        int idx = this.leftIndex;
                        this.leftIndex = idx + 1;
                        this.lefts.put(Integer.valueOf(idx), val);
                        try {
                            ObservableSource<TLeftEnd> p = (ObservableSource) ObjectHelper.requireNonNull(this.leftEnd.mo401apply(val), "The leftEnd returned a null ObservableSource");
                            ...
                            while (it.hasNext()) {
                                ...
                                try {
                                    ...
                                    a.onNext((Object) ObjectHelper.requireNonNull(this.resultSelector.mo374apply(val, right), "The resultSelector returned a null value"));
                                    it = it2;
                                } catch (Throwable exc) {
                                    fail(exc, a, q);
                                    return;
                        ...
                        try {
                            ObservableSource<TRightEnd> p2 = (ObservableSource) ObjectHelper.requireNonNull(this.rightEnd.mo401apply(val), "The rightEnd returned a null ObservableSource");
                            ...
                            while (it3.hasNext()) {
                                ...
                                try {
                                    ...
                                    a.onNext((Object) ObjectHelper.requireNonNull(this.resultSelector.mo374apply(left, val), "The resultSelector returned a null value"));
                                    it3 = it4;
