...
public final class ObservableScalarXMap {
    ...
    public static <T, R> boolean tryScalarXMapSubscribe(ObservableSource<T> source, Observer<? super R> observer, Function<? super T, ? extends ObservableSource<? extends R>> mapper) {
        if (source instanceof Callable) {
            try {
                ...
                try {
                    ObservableSource<? extends R> r = (ObservableSource) ObjectHelper.requireNonNull(mapper.mo401apply(obj), "The mapper returned a null ObservableSource");
    ...
    public static final class ScalarXMapObservable<T, R> extends Observable<R> {
        ...
        public void subscribeActual(Observer<? super R> observer) {
            try {
                ObservableSource<? extends R> other = (ObservableSource) ObjectHelper.requireNonNull(this.mapper.mo401apply((T) this.value), "The mapper returned a null ObservableSource");
    ...
    public static final class ScalarDisposable<T> extends AtomicInteger implements QueueDisposable<T>, Runnable {
        ...
        @Nullable
        /* renamed from: poll */
        public T mo399poll() throws Exception {
            if (get() == 1) {
                lazySet(3);
                return this.value;
            }
