...
public class NotificationCompat {
        ...
        RemoteViews generateContentView() {
            ...
            if (numActionsInCompact > 0) {
                for (int i = 0; i < numActionsInCompact; i++) {
                    ...
                    view.addView(C0200R.C0203id.media_actions, button);
                }
            }
        ...
        RemoteViews generateBigContentView() {
            ...
            if (actionCount > 0) {
                for (int i = 0; i < actionCount; i++) {
                    ...
                    big.addView(C0200R.C0203id.media_actions, button);
                }
            }
            if (this.mShowCancelButton) {
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        int getContentViewLayoutResource() {
            return this.mBuilder.getContentView() != null ? C0200R.layout.notification_template_media_custom : super.getContentViewLayoutResource();
        }
