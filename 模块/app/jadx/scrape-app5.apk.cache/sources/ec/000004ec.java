...
public class CardView extends FrameLayout {
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(C0456R.styleable.CardView_cardBackgroundColor)) {
            ...
            if (hsv[2] > 0.5f) {
                color = getResources().getColor(C0456R.C0457color.cardview_light_background);
            } else {
                color = getResources().getColor(C0456R.C0457color.cardview_dark_background);
            }
            backgroundColor = ColorStateList.valueOf(color);
        }
        int themeColorBackground2 = C0456R.styleable.CardView_cardCornerRadius;
