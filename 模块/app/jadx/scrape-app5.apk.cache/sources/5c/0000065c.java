...
public class MaterialDialog extends DialogBase implements View.OnClickListener, DefaultRvAdapter.InternalListCallback {
            ...
            public void onGlobalLayout() {
                ...
                if (MaterialDialog.this.listType == ListType.SINGLE || MaterialDialog.this.listType == ListType.MULTI) {
                    ...
                    MaterialDialog.this.recyclerView.post(new Runnable() { // from class: com.afollestad.materialdialogs.MaterialDialog.1.1
                        {
                            ViewTreeObserver$OnGlobalLayoutListenerC05771.this = this;
                        }
    ...
    public Drawable getButtonSelector(DialogAction which, boolean isStacked) {
        if (isStacked) {
            ...
            Drawable d = DialogUtils.resolveDrawable(this.builder.context, C0582R.attr.md_btn_stacked_selector);
            if (d != null) {
                return d;
            }
        ...
        switch (which) {
            case NEUTRAL:
                ...
                Drawable d2 = DialogUtils.resolveDrawable(this.builder.context, C0582R.attr.md_btn_neutral_selector);
                if (d2 != null) {
                    return d2;
                }
                Drawable d3 = DialogUtils.resolveDrawable(getContext(), C0582R.attr.md_btn_neutral_selector);
            ...
            case NEGATIVE:
                ...
                Drawable d4 = DialogUtils.resolveDrawable(this.builder.context, C0582R.attr.md_btn_negative_selector);
                if (d4 != null) {
                    return d4;
                }
                Drawable d5 = DialogUtils.resolveDrawable(getContext(), C0582R.attr.md_btn_negative_selector);
                if (Build.VERSION.SDK_INT >= 21) {
            ...
            default:
                ...
                Drawable d6 = DialogUtils.resolveDrawable(this.builder.context, C0582R.attr.md_btn_positive_selector);
                if (d6 != null) {
                    return d6;
                }
                Drawable d7 = DialogUtils.resolveDrawable(getContext(), C0582R.attr.md_btn_positive_selector);
                if (Build.VERSION.SDK_INT >= 21) {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            int materialBlue = DialogUtils.getColor(context, C0582R.C0583color.md_material_blue_600);
            this.widgetColor = DialogUtils.resolveColor(context, C0582R.attr.colorAccent, materialBlue);
            if (Build.VERSION.SDK_INT >= 21) {
            ...
            int fallback = 0;
            this.buttonRippleColor = DialogUtils.resolveColor(context, C0582R.attr.md_btn_ripple_color, DialogUtils.resolveColor(context, C0582R.attr.colorControlHighlight, Build.VERSION.SDK_INT >= 21 ? DialogUtils.resolveColor(context, 16843820) : fallback));
            ...
            String mediumFont = DialogUtils.resolveString(context, C0582R.attr.md_medium_font);
            String regularFont = DialogUtils.resolveString(context, C0582R.attr.md_regular_font);
            try {
