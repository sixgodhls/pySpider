...
public class AlertController {
    ...
    */
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0452R.C0455id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0452R.C0455id.scrollIndicatorDown);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            View titleTemplate = this.mWindow.findViewById(C0452R.C0455id.title_template);
        ...
        View titleTemplate2 = this.mWindow.findViewById(C0452R.C0455id.title_template);
