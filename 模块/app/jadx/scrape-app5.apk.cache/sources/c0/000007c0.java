...
public class TwinklingRefreshLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
    ...
    public TwinklingRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            this.mMaxHeadHeight = a.getDimensionPixelSize(C0843R.styleable.TwinklingRefreshLayout_tr_max_head_height, DensityUtil.dp2px(context, 120.0f));
            this.mHeadHeight = a.getDimensionPixelSize(C0843R.styleable.TwinklingRefreshLayout_tr_head_height, DensityUtil.dp2px(context, 80.0f));
            this.mMaxBottomHeight = a.getDimensionPixelSize(C0843R.styleable.TwinklingRefreshLayout_tr_max_bottom_height, DensityUtil.dp2px(context, 120.0f));
            this.mBottomHeight = a.getDimensionPixelSize(C0843R.styleable.TwinklingRefreshLayout_tr_bottom_height, DensityUtil.dp2px(context, 60.0f));
            this.mOverScrollHeight = a.getDimensionPixelSize(C0843R.styleable.TwinklingRefreshLayout_tr_overscroll_height, (int) this.mHeadHeight);
    ...
    private void detectGesture(MotionEvent ev, OnGestureListener listener) {
        ...
        switch (action & 255) {
            ...
            case 1:
                ...
                if (Math.abs(this.f75vy) > this.mMinimumFlingVelocity || Math.abs(this.f74vx) > this.mMinimumFlingVelocity) {
