...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        if (!sPendingTransitions.contains(sceneRoot)) {
            ...
            Transition transitionClone = transition.m129clone();
            transitionClone.mo143setSceneRoot(sceneRoot);
    ...
    public static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public boolean onPreDraw() {
            ...
            this.mTransition.mo130addListener(new TransitionListenerAdapter() { // from class: android.support.transition.TransitionManager.MultiListener.1
