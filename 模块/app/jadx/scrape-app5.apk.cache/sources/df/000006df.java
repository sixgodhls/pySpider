...
public final class ObservablePublishSelector<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    protected void subscribeActual(Observer<? super R> observer) {
        ...
        try {
            ObservableSource<? extends R> target = (ObservableSource) ObjectHelper.requireNonNull(this.selector.mo401apply(subject), "The selector returned a null ObservableSource");
