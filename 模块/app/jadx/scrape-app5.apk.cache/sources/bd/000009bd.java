...
public final class ObservableFlatMapSingle<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    static final class FlatMapSingleObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            try {
                SingleSource<? extends R> ms = (SingleSource) ObjectHelper.requireNonNull(this.mapper.mo401apply(t), "The mapper returned a null SingleSource");
        ...
        void drainLoop() {
            ...
            while (!this.cancelled) {
                ...
                R mo399poll = q != null ? q.mo399poll() : (Object) null;
                if (mo399poll != null) {
                    empty = false;
                }
                if (d && empty) {
