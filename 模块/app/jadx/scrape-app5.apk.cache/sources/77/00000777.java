...
public final class GzipSink implements Sink {
    ...
    private void writeHeader() {
        ...
        buffer.mo423writeShort(8075);
        buffer.mo416writeByte(8);
        buffer.mo416writeByte(0);
        buffer.mo419writeInt(0);
        buffer.mo416writeByte(0);
        buffer.mo416writeByte(0);
    }

    private void writeFooter() throws IOException {
        this.sink.mo420writeIntLe((int) this.crc.getValue());
        this.sink.mo420writeIntLe((int) this.deflater.getBytesRead());
    }
