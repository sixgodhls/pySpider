...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void setMeasuredDimension(Rect childrenBounds, int wSpec, int hSpec) {
        ...
        if (this.mOrientation == 1) {
            ...
            int usedWidth2 = chooseSize(hSpec, iArr2[iArr2.length - 1] + verticalPadding, getMinimumHeight());
            width = usedWidth2;
            usedHeight = width3;
        }
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult result) {
        ...
        if (flexibleInOtherDir) {
            ...
            for (int i4 = 0; i4 < count; i4++) {
                ...
                measureChild(view3, (int) MemoryConstants.f216GB, true);
        ...
        while (i5 < count) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view4) == maxSize) {
                ...
                if (this.mOrientation == 1) {
                    remainingSpan = remainingSpan3;
                    wSpec = getChildMeasureSpec(totalSpaceInOther, MemoryConstants.f216GB, horizontalInsets, lp.width, false);
                    hSpec = View.MeasureSpec.makeMeasureSpec(maxSize - verticalInsets, MemoryConstants.f216GB);
                } else {
                    remainingSpan = remainingSpan3;
                    wSpec = View.MeasureSpec.makeMeasureSpec(maxSize - horizontalInsets, MemoryConstants.f216GB);
                    hSpec = getChildMeasureSpec(totalSpaceInOther, MemoryConstants.f216GB, verticalInsets, lp.height, false);
                }
                ...
                if (candidate.hasFocusable() && spanGroupIndex != focusableSpanGroupIndex2) {
                    ...
                    if (assignAsWeek) {
                        if (candidate.hasFocusable()) {
                            ...
                            layoutDir2 = candidateLp.mSpanIndex;
