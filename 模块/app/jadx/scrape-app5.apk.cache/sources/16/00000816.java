...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(C0091R.styleable.NavigationView_elevation)) {
            ViewCompat.setElevation(this, a.getDimensionPixelSize(C0091R.styleable.NavigationView_elevation, 0));
        }
        ...
        itemTextColor = a.hasValue(C0091R.styleable.NavigationView_itemTextColor) ? a.getColorStateList(C0091R.styleable.NavigationView_itemTextColor) : itemTextColor;
        ...
        if (a.hasValue(C0091R.styleable.NavigationView_itemHorizontalPadding)) {
            int itemHorizontalPadding = a.getDimensionPixelSize(C0091R.styleable.NavigationView_itemHorizontalPadding, 0);
            this.presenter.setItemHorizontalPadding(itemHorizontalPadding);
        }
        int itemHorizontalPadding2 = C0091R.styleable.NavigationView_itemIconPadding;
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.design.widget.NavigationView.SavedState.1
            ...
            public SavedState mo122createFromParcel(Parcel in, ClassLoader loader) {
