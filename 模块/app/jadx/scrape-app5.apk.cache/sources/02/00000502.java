...
public class ViewPager extends ViewGroup {
    ...
    void populate(int newCurrentItem) {
        ...
        if (this.mAdapter == null) {
            ...
            if (curItem != null) {
                ...
                float leftWidthNeeded = clientWidth <= 0 ? 0.0f : (getPaddingLeft() / clientWidth) + (2.0f - curItem.widthFactor);
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.v4.view.ViewPager.SavedState.1
            ...
            public SavedState mo191createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo190createFromParcel(Parcel in) {
                return new SavedState(in, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo192newArray(int size) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                int widthSpec2 = View.MeasureSpec.makeMeasureSpec((int) (childWidthSize * lp.widthFactor), MemoryConstants.f216GB);
        ...
        while (true) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp.isDecor) {
                    ...
                    child.layout(childLeft2, childTop, child.getMeasuredWidth() + childLeft2, paddingTop3);
                    decorCount++;
                ...
                if (!lp2.isDecor) {
                    ...
                    if (ii == null) {
                        ...
                        if (!lp2.needsMeasure) {
                            ...
                            width = width2;
                            int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (childWidth * lp2.widthFactor), MemoryConstants.f216GB);
                            paddingLeft = paddingLeft2;
                            int paddingLeft4 = (height - paddingTop) - paddingBottom;
                            int heightSpec = View.MeasureSpec.makeMeasureSpec(paddingLeft4, MemoryConstants.f216GB);
    ...
    public class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle args) {
            ...
            if (action == 4096) {
                ...
                return true;
            } else if (action != 8192 || !ViewPager.this.canScrollHorizontally(-1)) {
                return false;
            } else {
