...
public abstract class LocalUriFetcher<T> implements DataFetcher<T> {
    ...
    protected abstract T mo283loadResource(Uri uri, ContentResolver contentResolver) throws FileNotFoundException;
    ...
    public final void loadData(@NonNull Priority priority, @NonNull DataFetcher.DataCallback<? super T> callback) {
        try {
            this.data = mo283loadResource(this.uri, this.contentResolver);
