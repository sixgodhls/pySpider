...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public OutputStream outputStream() {
        return new OutputStream() { // from class: okio.Buffer.1
            ...
            public void write(int b) {
                Buffer.this.mo354writeByte((int) ((byte) b));
            }

            @Override // java.io.OutputStream
            public void write(byte[] data, int offset, int byteCount) {
                Buffer.this.mo353write(data, offset, byteCount);
            }
    ...
    public Buffer mo350emitCompleteSegments() {
        return this;
    }
    ...
    */
    public long readHexadecimalUnsignedLong() {
        ...
        L4c:
            ...
            r2.<init>()
            okio.Buffer r2 = r2.mo356writeHexadecimalUnsignedLong(r0)
            okio.Buffer r2 = r2.mo354writeByte(r10)
    ...
    @Override // okio.BufferedSink
    /* renamed from: write */
    public Buffer mo351write(ByteString byteString) {
        if (byteString == null) {
    ...
    public Buffer mo365writeUtf8(String string) {
        return mo366writeUtf8(string, 0, string.length());
    }

    @Override // okio.BufferedSink
    /* renamed from: writeUtf8 */
    public Buffer mo366writeUtf8(String string, int beginIndex, int endIndex) {
        if (string == null) {
        ...
        if (beginIndex < 0) {
            ...
            while (i < endIndex) {
                ...
                if (c < 128) {
                    ...
                    mo354writeByte((c >> 6) | 192);
                    mo354writeByte(128 | (c & 63));
                    i++;
                } else if (c < 55296 || c > 57343) {
                    mo354writeByte((c >> 12) | 224);
                    mo354writeByte(((c >> 6) & 63) | 128);
                    mo354writeByte(128 | (c & 63));
                    i++;
                } else {
                    ...
                    if (c > 56319 || low < 56320 || low > 57343) {
                        ...
                        mo354writeByte((codePoint >> 18) | 240);
                        mo354writeByte(((codePoint >> 12) & 63) | 128);
                        mo354writeByte(((codePoint >> 6) & 63) | 128);
                        mo354writeByte(128 | (codePoint & 63));
                        i += 2;
                    }
                }
            }
    ...
    public Buffer mo367writeUtf8CodePoint(int codePoint) {
        if (codePoint < 128) {
            mo354writeByte(codePoint);
        } else if (codePoint < 2048) {
            mo354writeByte((codePoint >> 6) | 192);
            mo354writeByte(128 | (codePoint & 63));
        } else if (codePoint < 65536) {
            if (codePoint >= 55296 && codePoint <= 57343) {
                mo354writeByte(63);
            } else {
                mo354writeByte((codePoint >> 12) | 224);
                mo354writeByte(((codePoint >> 6) & 63) | 128);
                mo354writeByte(128 | (codePoint & 63));
            }
    ...
    public Buffer mo364writeString(String string, Charset charset) {
        return mo363writeString(string, 0, string.length(), charset);
    }

    @Override // okio.BufferedSink
    /* renamed from: writeString */
    public Buffer mo363writeString(String string, int beginIndex, int endIndex, Charset charset) {
        if (string == null) {
            throw new IllegalArgumentException("string == null");
        }
        if (beginIndex < 0) {
            ...
            if (charset.equals(Util.UTF_8)) {
                return mo366writeUtf8(string, beginIndex, endIndex);
            }
            byte[] data = string.substring(beginIndex, endIndex).getBytes(charset);
            return mo353write(data, 0, data.length);
        }
    }

    @Override // okio.BufferedSink
    /* renamed from: write */
    public Buffer mo352write(byte[] source) {
        if (source == null) {
            throw new IllegalArgumentException("source == null");
        }
        return mo353write(source, 0, source.length);
    }

    @Override // okio.BufferedSink
    /* renamed from: write */
    public Buffer mo353write(byte[] source, int offset, int byteCount) {
        if (source == null) {
            throw new IllegalArgumentException("source == null");
        }
    ...
    public Buffer mo354writeByte(int b) {
        Segment tail = writableSegment(1);
        byte[] bArr = tail.data;
        int i = tail.limit;
        tail.limit = i + 1;
    ...
    public Buffer mo361writeShort(int s) {
    ...
    public Buffer mo362writeShortLe(int s) {
        return mo361writeShort((int) Util.reverseBytesShort((short) s));
    }

    @Override // okio.BufferedSink
    /* renamed from: writeInt */
    public Buffer mo357writeInt(int i) {
    ...
    public Buffer mo358writeIntLe(int i) {
        return mo357writeInt(Util.reverseBytesInt(i));
    }

    @Override // okio.BufferedSink
    /* renamed from: writeLong */
    public Buffer mo359writeLong(long v) {
    ...
    public Buffer mo360writeLongLe(long v) {
        return mo359writeLong(Util.reverseBytesLong(v));
    }

    @Override // okio.BufferedSink
    /* renamed from: writeDecimalLong */
    public Buffer mo355writeDecimalLong(long v) {
        int width;
        if (v == 0) {
            return mo354writeByte(48);
        }
        boolean negative = false;
        if (v < 0) {
            v = -v;
            if (v < 0) {
                return mo365writeUtf8("-9223372036854775808");
            }
            negative = true;
        }
        if (v < 100000000) {
    ...
    public Buffer mo356writeHexadecimalUnsignedLong(long v) {
        if (v == 0) {
            return mo354writeByte(48);
        }
