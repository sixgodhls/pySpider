...
public final class FlowableMap<T, U> extends AbstractFlowableWithUpstream<T, U> {
    ...
    static final class MapSubscriber<T, U> extends BasicFuseableSubscriber<T, U> {
        ...
        public void onNext(T t) {
            ...
            try {
                this.downstream.onNext(ObjectHelper.requireNonNull(this.mapper.mo339apply(t), "The mapper function returned a null value."));
            } catch (Throwable ex) {
                fail(ex);
            }
        }
        ...
        @Nullable
        /* renamed from: poll */
        public U mo337poll() throws Exception {
            T t = this.qs.poll();
            if (t != null) {
                return (U) ObjectHelper.requireNonNull(this.mapper.mo339apply(t), "The mapper function returned a null value.");
            }
            return null;
        }
    }
    ...
    static final class MapConditionalSubscriber<T, U> extends BasicFuseableConditionalSubscriber<T, U> {
        ...
        public boolean tryOnNext(T t) {
            ...
            try {
                return this.downstream.tryOnNext(ObjectHelper.requireNonNull(this.mapper.mo339apply(t), "The mapper function returned a null value."));
            } catch (Throwable ex) {
                fail(ex);
                return true;
            }
