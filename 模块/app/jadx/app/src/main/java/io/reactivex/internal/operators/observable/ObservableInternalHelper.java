...
public final class ObservableInternalHelper {
    ...
    public static final class SimpleGenerator<T, S> implements BiFunction<S, Emitter<T>, S> {
        ...
        /* renamed from: apply */
        public /* bridge */ /* synthetic */ Object mo312apply(Object obj, Object obj2) throws Exception {
    ...
    public static final class ItemDelayFunction<T, U> implements Function<T, ObservableSource<T>> {
        ...
        public /* bridge */ /* synthetic */ Object mo339apply(Object obj) throws Exception {
            return mo339apply((ItemDelayFunction<T, U>) obj);
        }
        ...
        @Override // io.reactivex.functions.Function
        /* renamed from: apply */
        public ObservableSource<T> mo339apply(T v) throws Exception {
            ObservableSource<U> o = (ObservableSource) ObjectHelper.requireNonNull(this.itemDelay.mo339apply(v), "The itemDelay returned a null ObservableSource");
    ...
    public static final class FlatMapWithCombinerInner<U, R, T> implements Function<U, R> {
        ...
        @Override // io.reactivex.functions.Function
        /* renamed from: apply */
        public R mo339apply(U w) throws Exception {
            return this.combiner.mo312apply((T) this.t, w);
        }
    }
    ...
    public static final class FlatMapWithCombinerOuter<T, R, U> implements Function<T, ObservableSource<R>> {
        ...
        /* renamed from: apply  reason: collision with other method in class */
        public /* bridge */ /* synthetic */ Object mo339apply(Object obj) throws Exception {
            return mo339apply((FlatMapWithCombinerOuter<T, R, U>) obj);
        }
        ...
        @Override // io.reactivex.functions.Function
        /* renamed from: apply */
        public ObservableSource<R> mo339apply(T t) throws Exception {
            ObservableSource<U> u = (ObservableSource) ObjectHelper.requireNonNull(this.mapper.mo339apply(t), "The mapper returned a null ObservableSource");
    ...
    public static final class FlatMapIntoIterable<T, U> implements Function<T, ObservableSource<U>> {
        ...
        /* renamed from: apply  reason: collision with other method in class */
        public /* bridge */ /* synthetic */ Object mo339apply(Object obj) throws Exception {
            return mo339apply((FlatMapIntoIterable<T, U>) obj);
        }
        ...
        @Override // io.reactivex.functions.Function
        /* renamed from: apply */
        public ObservableSource<U> mo339apply(T t) throws Exception {
            return new ObservableFromIterable((Iterable) ObjectHelper.requireNonNull(this.mapper.mo339apply(t), "The mapper returned a null Iterable"));
        }
    }
    ...
    enum MapToInt implements Function<Object, Object> {
        ...
        @Override // io.reactivex.functions.Function
        /* renamed from: apply */
        public Object mo339apply(Object t) throws Exception {
            return 0;
        }
    }
    ...
    public static final class ReplayCallable<T> implements Callable<ConnectableObservable<T>> {
        ...
        /* renamed from: call */
        public ConnectableObservable<T> mo334call() {
    ...
    public static final class BufferedReplayCallable<T> implements Callable<ConnectableObservable<T>> {
        ...
        @Override // java.util.concurrent.Callable
        /* renamed from: call */
        public ConnectableObservable<T> mo329call() {
    ...
    public static final class BufferedTimedReplayCallable<T> implements Callable<ConnectableObservable<T>> {
        ...
        @Override // java.util.concurrent.Callable
        /* renamed from: call */
        public ConnectableObservable<T> mo330call() {
    ...
    public static final class TimedReplayCallable<T> implements Callable<ConnectableObservable<T>> {
        ...
        @Override // java.util.concurrent.Callable
        /* renamed from: call */
        public ConnectableObservable<T> mo335call() {
    ...
    public static final class ReplayFunction<T, R> implements Function<Observable<T>, ObservableSource<R>> {
        ...
        public ObservableSource<R> apply(Observable<T> t) throws Exception {
            ObservableSource<R> apply = (ObservableSource) ObjectHelper.requireNonNull(this.selector.mo339apply(t), "The selector returned a null ObservableSource");
