...
public final class FlowableZipIterable<T, U, V> extends AbstractFlowableWithUpstream<T, V> {
    ...
    static final class ZipIterableSubscriber<T, U, V> implements FlowableSubscriber<T>, Subscription {
        ...
        public void onNext(T t) {
            ...
            try {
                try {
                    this.downstream.onNext(ObjectHelper.requireNonNull(this.zipper.mo312apply(t, ObjectHelper.requireNonNull(this.iterator.next(), "The iterator returned a null value")), "The zipper function returned a null value"));
                    try {
