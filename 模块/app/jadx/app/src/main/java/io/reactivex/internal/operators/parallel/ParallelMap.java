...
public final class ParallelMap<T, R> extends ParallelFlowable<R> {
    ...
    static final class ParallelMapSubscriber<T, R> implements FlowableSubscriber<T>, Subscription {
        ...
        public void onNext(T t) {
            ...
            try {
                this.downstream.onNext(ObjectHelper.requireNonNull(this.mapper.mo339apply(t), "The mapper returned a null value"));
            } catch (Throwable ex) {
    ...
    static final class ParallelMapConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T t) {
            ...
            try {
                return this.downstream.tryOnNext(ObjectHelper.requireNonNull(this.mapper.mo339apply(t), "The mapper returned a null value"));
            } catch (Throwable ex) {
                Exceptions.throwIfFatal(ex);
                cancel();
                onError(ex);
