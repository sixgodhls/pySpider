...
public final class FlowableMapNotification<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    static final class MapNotificationSubscriber<T, R> extends SinglePostCompleteSubscriber<T, R> {
        ...
        public void onNext(T t) {
            try {
                Object requireNonNull = ObjectHelper.requireNonNull(this.onNextMapper.mo339apply(t), "The onNext publisher returned is null");
                this.produced++;
        ...
        public void onError(Throwable t) {
            try {
                complete(ObjectHelper.requireNonNull(this.onErrorMapper.mo339apply(t), "The onError publisher returned is null"));
            } catch (Throwable e) {
                Exceptions.throwIfFatal(e);
