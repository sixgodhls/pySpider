            ...
            while (!this.cancelled) {
                ...
                if (d && empty) {
                    ...
                    if (mode == LEFT_VALUE) {
                        ...
                        try {
                            ObservableSource<TLeftEnd> p = (ObservableSource) ObjectHelper.requireNonNull(this.leftEnd.mo339apply(val), "The leftEnd returned a null ObservableSource");
                            ...
                            while (it.hasNext()) {
                                ...
                                try {
                                    ...
                                    a.onNext((Object) ObjectHelper.requireNonNull(this.resultSelector.mo312apply(val, right), "The resultSelector returned a null value"));
                                    it = it2;
                                } catch (Throwable exc) {
                                    fail(exc, a, q);
                                    return;
                        ...
                        try {
                            ObservableSource<TRightEnd> p2 = (ObservableSource) ObjectHelper.requireNonNull(this.rightEnd.mo339apply(val), "The rightEnd returned a null ObservableSource");
                            ...
                            while (it3.hasNext()) {
                                ...
                                try {
                                    ...
                                    a.onNext((Object) ObjectHelper.requireNonNull(this.resultSelector.mo312apply(left, val), "The resultSelector returned a null value"));
                                    it3 = it4;
