                ...
                if (!this.active) {
                    ...
                    try {
                        ...
                        if (d && empty) {
                            ...
                            try {
                                ObservableSource<? extends U> o = (ObservableSource) ObjectHelper.requireNonNull(this.mapper.mo339apply(t), "The mapper returned a null ObservableSource");
                                this.active = true;
                    ...
                    if (this.cancelled) {
                        ...
                        try {
                            ...
                            if (d && empty) {
                                ...
                                try {
                                    ObservableSource<? extends R> o = (ObservableSource) ObjectHelper.requireNonNull(this.mapper.mo339apply(v), "The mapper returned a null ObservableSource");
