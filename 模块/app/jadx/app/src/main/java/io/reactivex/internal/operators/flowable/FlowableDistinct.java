    ...
    static final class DistinctSubscriber<T, K> extends BasicFuseableSubscriber<T, T> {
        ...
        public void onNext(T value) {
            ...
            if (this.sourceMode == 0) {
                try {
                    boolean b = this.collection.add(ObjectHelper.requireNonNull(this.keySelector.mo339apply(value), "The keySelector returned a null key"));
                    if (b) {
        ...
        public T mo337poll() throws Exception {
            ...
            while (true) {
                v = this.qs.poll();
                if (v == null || this.collection.add((Object) ObjectHelper.requireNonNull(this.keySelector.mo339apply(v), "The keySelector returned a null key"))) {
                    break;
