    ...
    public static <T> boolean tryAsCompletable(Object source, Function<? super T, ? extends CompletableSource> mapper, CompletableObserver observer) {
        if (source instanceof Callable) {
            ...
            try {
                ...
                if (obj != 0) {
                    cs = (CompletableSource) ObjectHelper.requireNonNull(mapper.mo339apply(obj), "The mapper returned a null CompletableSource");
                }
                if (cs == null) {
    ...
    public static <T, R> boolean tryAsMaybe(Object source, Function<? super T, ? extends MaybeSource<? extends R>> mapper, Observer<? super R> observer) {
        if (source instanceof Callable) {
            ...
            try {
                Object obj = (Object) call.call();
                if (obj != 0) {
                    cs = (MaybeSource) ObjectHelper.requireNonNull(mapper.mo339apply(obj), "The mapper returned a null MaybeSource");
                }
                if (cs == null) {
                    EmptyDisposable.complete(observer);
                } else {
    ...
    public static <T, R> boolean tryAsSingle(Object source, Function<? super T, ? extends SingleSource<? extends R>> mapper, Observer<? super R> observer) {
        if (source instanceof Callable) {
            ...
            try {
                Object obj = (Object) call.call();
                if (obj != 0) {
                    cs = (SingleSource) ObjectHelper.requireNonNull(mapper.mo339apply(obj), "The mapper returned a null SingleSource");
                }
                if (cs == null) {
                    EmptyDisposable.complete(observer);
                } else {
