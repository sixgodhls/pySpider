...
public final class ObservableUsing<T, D> extends Observable<T> {
    ...
    public void subscribeActual(Observer<? super T> observer) {
        try {
            ...
            try {
                ObservableSource<? extends T> source = (ObservableSource) ObjectHelper.requireNonNull(this.sourceSupplier.mo339apply(resource), "The sourceSupplier returned a null ObservableSource");
