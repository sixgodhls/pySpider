...
public final class FlowableScalarXMap {
    ...
    public static <T, R> boolean tryScalarXMapSubscribe(Publisher<T> source, Subscriber<? super R> subscriber, Function<? super T, ? extends Publisher<? extends R>> mapper) {
        if (source instanceof Callable) {
            try {
                ...
                try {
                    Publisher<? extends R> r = (Publisher) ObjectHelper.requireNonNull(mapper.mo339apply(obj), "The mapper returned a null Publisher");
    ...
    public static final class ScalarXMapFlowable<T, R> extends Flowable<R> {
        ...
        public void subscribeActual(Subscriber<? super R> s) {
            try {
                Publisher<? extends R> other = (Publisher) ObjectHelper.requireNonNull(this.mapper.mo339apply((T) this.value), "The mapper returned a null Publisher");
