...
public abstract class BaseTestConsumer<T, U extends BaseTestConsumer<T, U>> implements Disposable {
    ...
    /* renamed from: assertNotSubscribed */
    public abstract U mo346assertNotSubscribed();

    /* renamed from: assertSubscribed */
    public abstract U mo347assertSubscribed();
    ...
    public final U assertValuesOnly(T... values) {
        return (U) mo347assertSubscribed().assertValues(values).assertNoErrors().assertNotComplete();
    }
    ...
    public final U assertValueSetOnly(Collection<? extends T> expected) {
        return (U) mo347assertSubscribed().assertValueSet(expected).assertNoErrors().assertNotComplete();
    }
    ...
    public final U assertValueSequenceOnly(Iterable<? extends T> sequence) {
        return (U) mo347assertSubscribed().assertValueSequence(sequence).assertNoErrors().assertNotComplete();
    }
    ...
    public final U assertResult(T... values) {
        return (U) mo347assertSubscribed().assertValues(values).assertNoErrors().assertComplete();
    }

    public final U assertFailure(Class<? extends Throwable> error, T... values) {
        return (U) mo347assertSubscribed().assertValues(values).assertError(error).assertNotComplete();
    }

    public final U assertFailure(Predicate<Throwable> errorPredicate, T... values) {
        return (U) mo347assertSubscribed().assertValues(values).assertError(errorPredicate).assertNotComplete();
    }

    public final U assertFailureAndMessage(Class<? extends Throwable> error, String message, T... values) {
        return (U) mo347assertSubscribed().assertValues(values).assertError(error).assertErrorMessage(message).assertNotComplete();
    }
    ...
    public final U assertEmpty() {
        return (U) mo347assertSubscribed().assertNoValues().assertNoErrors().assertNotComplete();
    }
