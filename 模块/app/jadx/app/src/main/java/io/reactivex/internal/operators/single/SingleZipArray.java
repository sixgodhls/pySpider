...
public final class SingleZipArray<T, R> extends Single<R> {
    ...
    static final class ZipCoordinator<T, R> extends AtomicInteger implements Disposable {
        ...
        void innerSuccess(T value, int index) {
            ...
            if (decrementAndGet() == 0) {
                try {
                    this.downstream.onSuccess(ObjectHelper.requireNonNull(this.zipper.mo339apply(this.values), "The zipper returned a null value"));
                } catch (Throwable ex) {
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R mo339apply(T t) throws Exception {
            return (R) ObjectHelper.requireNonNull(SingleZipArray.this.zipper.mo339apply(new Object[]{t}), "The zipper returned a null value");
        }
    }
}
