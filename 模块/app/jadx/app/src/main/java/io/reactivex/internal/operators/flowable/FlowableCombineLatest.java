...
public final class FlowableCombineLatest<T, R> extends Flowable<R> {
    ...
    static final class CombineLatestCoordinator<T, R> extends BasicIntQueueSubscription<R> {
        ...
        void drainAsync() {
            ...
            do {
                ...
                while (e != r) {
                    ...
                    try {
                        a.onNext((Object) ObjectHelper.requireNonNull(this.combiner.mo339apply((Object[]) q.mo337poll()), "The combiner returned a null value"));
        ...
        @Nullable
        /* renamed from: poll */
        public R mo337poll() throws Exception {
            Object e = this.queue.mo337poll();
            if (e == null) {
                return null;
            }
            R r = (R) ObjectHelper.requireNonNull(this.combiner.mo339apply((Object[]) this.queue.mo337poll()), "The combiner returned a null value");
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        /* renamed from: apply */
        public R mo339apply(T t) throws Exception {
            return FlowableCombineLatest.this.combiner.mo339apply(new Object[]{t});
        }
    }
}
