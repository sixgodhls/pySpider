...
public abstract class Transition implements Cloneable {
    ...
    public Transition mo79setDuration(long duration) {
    ...
    public Transition mo82setStartDelay(long startDelay) {
    ...
    public Transition mo80setInterpolator(@Nullable TimeInterpolator interpolator) {
    ...
    public Transition mo70addTarget(@NonNull View target) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo69addTarget(@IdRes int targetId) {
        if (targetId != 0) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo72addTarget(@NonNull String targetName) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo71addTarget(@NonNull Class targetType) {
        if (this.mTargetTypes == null) {
    ...
    public Transition mo76removeTarget(@NonNull View target) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo75removeTarget(@IdRes int targetId) {
        if (targetId != 0) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo78removeTarget(@NonNull String targetName) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo77removeTarget(@NonNull Class target) {
    ...
    public Transition mo68addListener(@NonNull TransitionListener listener) {
    ...
    public Transition mo74removeListener(@NonNull TransitionListener listener) {
        ArrayList<TransitionListener> arrayList = this.mListeners;
        if (arrayList == null) {
            return this;
        }
    ...
    public Transition mo81setSceneRoot(ViewGroup sceneRoot) {
