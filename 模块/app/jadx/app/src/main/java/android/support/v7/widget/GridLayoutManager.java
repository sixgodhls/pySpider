    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult result) {
        ...
        if (flexibleInOtherDir) {
            ...
            for (int i4 = 0; i4 < count; i4++) {
                ...
                measureChild(view3, (int) MemoryConstants.GB, true);
        ...
        while (i5 < count) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view4) == maxSize) {
                ...
                if (this.mOrientation == 1) {
                    remainingSpan = remainingSpan3;
                    wSpec = getChildMeasureSpec(totalSpaceInOther, MemoryConstants.GB, horizontalInsets, lp.width, false);
                    hSpec = View.MeasureSpec.makeMeasureSpec(maxSize - verticalInsets, MemoryConstants.GB);
                } else {
                    remainingSpan = remainingSpan3;
                    wSpec = View.MeasureSpec.makeMeasureSpec(maxSize - horizontalInsets, MemoryConstants.GB);
                    hSpec = getChildMeasureSpec(totalSpaceInOther, MemoryConstants.GB, verticalInsets, lp.height, false);
                }
