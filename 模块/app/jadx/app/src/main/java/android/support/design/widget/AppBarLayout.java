...
public class AppBarLayout extends LinearLayout {
    ...
    public LayoutParams mo34generateDefaultLayoutParams() {
        return new LayoutParams(-1, -2);
    }

    @Override // android.widget.LinearLayout, android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo37generateLayoutParams(AttributeSet attrs) {
    ...
    @Override // android.widget.LinearLayout, android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo38generateLayoutParams(ViewGroup.LayoutParams p) {
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, T abl) {
            ...
            if (offsetChildIndex >= 0) {
                ...
                if ((flags & 17) == 17) {
                    ...
                    animateOffsetTo(coordinatorLayout, abl, android.support.v4.math.MathUtils.clamp(newOffset, -abl.getTotalScrollRange(), 0), 0.0f);
                }
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout parent, T abl, int layoutDirection) {
            ...
            setTopAndBottomOffset(android.support.v4.math.MathUtils.clamp(getTopAndBottomOffset(), -abl.getTotalScrollRange(), 0));
        ...
        int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, T appBarLayout, int newOffset, int minOffset, int maxOffset) {
            ...
            if (minOffset != 0 && curOffset >= minOffset && curOffset <= maxOffset) {
                int newOffset2 = android.support.v4.math.MathUtils.clamp(newOffset, minOffset, maxOffset);
        ...
        public static class SavedState extends AbsSavedState {
            public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.design.widget.AppBarLayout.BaseBehavior.SavedState.1
                ...
                public SavedState mo40createFromParcel(Parcel source, ClassLoader loader) {
                    return new SavedState(source, loader);
                }

                @Override // android.os.Parcelable.Creator
                /* renamed from: createFromParcel */
                public SavedState mo39createFromParcel(Parcel source) {
                    return new SavedState(source, null);
                }

                @Override // android.os.Parcelable.Creator
                /* renamed from: newArray */
                public SavedState[] mo41newArray(int size) {
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        /* bridge */ /* synthetic */ View mo42findFirstDependency(List list) {
            return mo42findFirstDependency((List<View>) list);
        }
        ...
        public boolean onRequestChildRectangleOnScreen(CoordinatorLayout parent, View child, Rect rectangle, boolean immediate) {
            AppBarLayout header = mo42findFirstDependency(parent.getDependencies(child));
            if (header != null) {
        ...
        AppBarLayout mo42findFirstDependency(List<View> views) {
            int z = views.size();
            for (int i = 0; i < z; i++) {
