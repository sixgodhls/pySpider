...
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem {
    ...
    public MenuItem setShowAsActionFlags(int actionEnum) {
        ((SupportMenuItem) this.mWrappedObject).mo154setShowAsActionFlags(actionEnum);
        return this;
    }
    ...
    public MenuItem setActionView(View view) {
        ...
        ((SupportMenuItem) this.mWrappedObject).mo152setActionView(view);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setActionView(int resId) {
        ((SupportMenuItem) this.mWrappedObject).mo151setActionView(resId);
        View actionView = ((SupportMenuItem) this.mWrappedObject).getActionView();
        if (actionView instanceof CollapsibleActionView) {
            ((SupportMenuItem) this.mWrappedObject).mo152setActionView(new CollapsibleActionViewWrapper(actionView));
        }
        return this;
    }
    ...
    public MenuItem setContentDescription(CharSequence contentDescription) {
        ((SupportMenuItem) this.mWrappedObject).mo153setContentDescription(contentDescription);
        return this;
    }
    ...
    public MenuItem setTooltipText(CharSequence tooltipText) {
        ((SupportMenuItem) this.mWrappedObject).mo155setTooltipText(tooltipText);
        return this;
    }
