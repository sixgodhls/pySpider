...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.v4.view.ViewPager.SavedState.1
            ...
            public SavedState mo129createFromParcel(Parcel in, ClassLoader loader) {
            ...
            public SavedState[] mo130newArray(int size) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                int widthSpec2 = View.MeasureSpec.makeMeasureSpec((int) (childWidthSize * lp.widthFactor), MemoryConstants.GB);
                ...
                if (!lp2.isDecor) {
                    ...
                    if (ii == null) {
                        ...
                        if (!lp2.needsMeasure) {
                            ...
                            width = width2;
                            int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (childWidth * lp2.widthFactor), MemoryConstants.GB);
                            paddingLeft = paddingLeft2;
                            int paddingLeft4 = (height - paddingTop) - paddingBottom;
                            int heightSpec = View.MeasureSpec.makeMeasureSpec(paddingLeft4, MemoryConstants.GB);
