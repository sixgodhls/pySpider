                ...
                if (parentMatches(startParent, endParent)) {
                    ...
                    if (numChanges > 0) {
                        if (this.mResizeClip) {
                            ...
                            ViewUtils.setLeftTopRightBottom(view, startLeft, startTop2, startLeft + maxWidth, startTop2 + maxHeight);
                            if (startLeft == endLeft2 && startTop2 == endTop) {
                                endLeft = endLeft2;
                            ...
                            if (numChanges == 2) {
                                if (startWidth == endWidth && startHeight == endHeight) {
                                    ...
                                    anim = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, topLeftPath2);
                                    z = true;
                                } else {
                                    final ViewBounds viewBounds = new ViewBounds(view);
                                    Path topLeftPath3 = getPathMotion().getPath(startLeft, startTop2, endLeft2, endTop);
                                    ObjectAnimator topLeftAnimator = ObjectAnimatorUtils.ofPointF(viewBounds, TOP_LEFT_PROPERTY, topLeftPath3);
