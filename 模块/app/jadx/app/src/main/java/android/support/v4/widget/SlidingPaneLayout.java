                        ...
                        if (!canSlide || child2 == this.mSlideableView) {
                            ...
                            if (lp2.weight <= 0.0f) {
                                ...
                                if (canSlide) {
                                    ...
                                    int childWidthSpec3 = View.MeasureSpec.makeMeasureSpec(measuredWidth + addedWidth, MemoryConstants.GB);
    ...
    */
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.v4.widget.SlidingPaneLayout.SavedState.1
            ...
            public SavedState mo137createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo136createFromParcel(Parcel in) {
                return new SavedState(in, null);
            }
