...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    abstract View mo42findFirstDependency(List<View> list);
    ...
    public boolean onMeasureChild(CoordinatorLayout parent, View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        ...
        if (childLpHeight == -1 || childLpHeight == -2) {
            ...
            View header = mo42findFirstDependency(dependencies);
            if (header != null) {
                ...
                int heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(height, childLpHeight == -1 ? MemoryConstants.GB : Integer.MIN_VALUE);
    ...
    public final int getOverlapPixelsForOffset(View header) {
        ...
        return android.support.v4.math.MathUtils.clamp((int) (overlapRatioForOffset * i), 0, i);
    }
