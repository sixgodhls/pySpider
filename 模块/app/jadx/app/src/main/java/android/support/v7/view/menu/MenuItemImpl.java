...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public SupportMenuItem mo152setActionView(View view) {
        int i;
    ...
    @Override // android.support.v4.internal.view.SupportMenuItem, android.view.MenuItem
    /* renamed from: setActionView */
    public SupportMenuItem mo151setActionView(int resId) {
        Context context = this.mMenu.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        mo152setActionView(inflater.inflate(resId, (ViewGroup) new LinearLayout(context), false));
        return this;
    }
    ...
    public SupportMenuItem mo154setShowAsActionFlags(int actionEnum) {
    ...
    public SupportMenuItem mo153setContentDescription(CharSequence contentDescription) {
    ...
    public SupportMenuItem mo155setTooltipText(CharSequence tooltipText) {
