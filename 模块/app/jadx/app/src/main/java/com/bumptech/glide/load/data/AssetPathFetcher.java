...
public abstract class AssetPathFetcher<T> implements DataFetcher<T> {
    ...
    protected abstract T mo220loadResource(AssetManager assetManager, String str) throws IOException;
    ...
    public void loadData(@NonNull Priority priority, @NonNull DataFetcher.DataCallback<? super T> callback) {
        try {
            this.data = mo220loadResource(this.assetManager, this.assetPath);
