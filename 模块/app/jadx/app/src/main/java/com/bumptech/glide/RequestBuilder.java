...
public class RequestBuilder<TranscodeType> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    protected RequestOptions getMutableOptions() {
        ...
        return requestOptions2.m240clone();
    }
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo211load(@Nullable Object model) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo206load(@Nullable Bitmap bitmap) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo207load(@Nullable Drawable drawable) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo212load(@Nullable String string) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo208load(@Nullable Uri uri) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo209load(@Nullable File file) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo210load(@RawRes @DrawableRes @Nullable Integer resourceId) {
    ...
    @Deprecated
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo213load(@Nullable URL url) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo214load(@Nullable byte[] model) {
    ...
    @CheckResult
    /* renamed from: clone */
    public RequestBuilder<TranscodeType> m196clone() {
        try {
            RequestBuilder<TranscodeType> result = (RequestBuilder) super.clone();
            result.requestOptions = result.requestOptions.m240clone();
            result.transitionOptions = (TransitionOptions<?, ? super TranscodeType>) result.transitionOptions.m215clone();
            return result;
    ...
    public ViewTarget<ImageView, TranscodeType> into(@NonNull ImageView view) {
        ...
        if (!requestOptions.isTransformationSet() && requestOptions.isTransformationAllowed() && view.getScaleType() != null) {
            switch (AnonymousClass2.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
                case 1:
                    requestOptions = requestOptions.m240clone().optionalCenterCrop();
                    break;
                case 2:
                    requestOptions = requestOptions.m240clone().optionalCenterInside();
                    break;
                case 3:
                case 4:
                case 5:
                    requestOptions = requestOptions.m240clone().optionalFitCenter();
                    break;
                case 6:
                    requestOptions = requestOptions.m240clone().optionalCenterInside();
                    break;
    ...
    private Request buildThumbnailRequestRecursive(Target<TranscodeType> target, RequestListener<TranscodeType> targetListener, @Nullable RequestCoordinator parentCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int overrideWidth, int overrideHeight, RequestOptions requestOptions) {
        ...
        if (requestBuilder != null) {
            ...
            RequestOptions thumbnailOptions = requestOptions.m240clone().sizeMultiplier(this.thumbSizeMultiplier.floatValue());
