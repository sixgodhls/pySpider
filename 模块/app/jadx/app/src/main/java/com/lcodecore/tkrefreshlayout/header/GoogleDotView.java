            ...
            if (this.animating) {
                switch (i) {
                    case 0:
                        ...
                        canvas.drawCircle(((getMeasuredWidth() / 2) - (this.cir_x * 2)) - (((w * 2) / 3) * 2), getMeasuredHeight() / 2, this.r * this.fraction2, this.mPath);
                        continue;
                    case 1:
                        this.mPath.setAlpha(145);
                        this.mPath.setColor(getResources().getColor(R.color.Green));
                        canvas.drawCircle(((getMeasuredWidth() / 2) - (this.cir_x * 1)) - ((w / 3) * 2), getMeasuredHeight() / 2, this.r * this.fraction2, this.mPath);
                        continue;
                    case 2:
                        this.mPath.setAlpha(255);
                        this.mPath.setColor(getResources().getColor(R.color.Blue));
                        canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, this.r * this.fraction1, this.mPath);
                        continue;
                    case 3:
                        this.mPath.setAlpha(145);
                ...
                switch (i) {
                    case 0:
                        this.mPath.setAlpha(105);
                        this.mPath.setColor(getResources().getColor(R.color.Yellow));
                        canvas.drawCircle(((getMeasuredWidth() / 2) - (this.cir_x * 2)) - (((w * 2) / 3) * 2), getMeasuredHeight() / 2, this.r, this.mPath);
                        continue;
                    case 1:
                        this.mPath.setAlpha(145);
                        this.mPath.setColor(getResources().getColor(R.color.Green));
                        canvas.drawCircle(((getMeasuredWidth() / 2) - (this.cir_x * 1)) - ((w / 3) * 2), getMeasuredHeight() / 2, this.r, this.mPath);
                        continue;
                    case 2:
                        this.mPath.setAlpha(255);
                        this.mPath.setColor(getResources().getColor(R.color.Blue));
