...
public abstract class LocalUriFetcher<T> implements DataFetcher<T> {
    ...
    protected abstract T mo221loadResource(Uri uri, ContentResolver contentResolver) throws FileNotFoundException;
    ...
    public final void loadData(@NonNull Priority priority, @NonNull DataFetcher.DataCallback<? super T> callback) {
        try {
            this.data = mo221loadResource(this.uri, this.contentResolver);
