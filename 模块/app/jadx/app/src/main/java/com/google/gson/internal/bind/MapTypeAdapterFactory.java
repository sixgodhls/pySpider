...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        public Map<K, V> mo291read(JsonReader in) throws IOException {
            ...
            if (peek == JsonToken.BEGIN_ARRAY) {
                ...
                while (in.hasNext()) {
                    in.beginArray();
                    K key = this.keyTypeAdapter.mo291read(in);
                    V value = this.valueTypeAdapter.mo291read(in);
                ...
                while (in.hasNext()) {
                    ...
                    K key2 = this.keyTypeAdapter.mo291read(in);
                    V value2 = this.valueTypeAdapter.mo291read(in);
